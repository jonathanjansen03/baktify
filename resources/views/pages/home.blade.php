...
@section('main-content')
    <h1 id="hero_text" class="text-center text-black">
      Level Up Your<br>
      Music Collection
    </h1>
    ...
    <div class="home-middle-container">
      <div class="home-middle">
        ...
        <div class="home-middle-desc">
          <h5 class="text-right text-black">Completely Secure and Flexible Payments</h5>
          <p class="text-right">
      ...
      <div class="home-middle">
        ...
        <div class="home-middle-desc">
          <h5 class="text-black">Bulk Ordering Makes it Possible</h5>
          <p>
