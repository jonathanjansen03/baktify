...
@section('main-content')
	<div id="product-detail-container" class="mx-auto">
		<div class="text-center">
			<img src="https://images.squarespace-cdn.com/content/v1/565c1ab5e4b05079e4bfa169/1594354844764-AS3MIE2RV9MAWWFK4RHA/Shania+Twain+Come+On+Over+Album+Cover+International+Version.jpg" alt="Product" class="img-fluid rounded mx-auto">
		</div>
