...
@section('main-content')
    <h1 id="hero_text" class="text-center">
      Level Up Your<br>
      Music Collection
    </h1>
    ...
    <div class="hr-text">
      <hr>
      <h5 class="text-center">One-stop store for all your musical enthusiasm needs</h5>
    ...
    <div class="home-middle-container">
      <div class="home-middle">
        ...
        <div class="home-middle-desc">
          <h5 class="text-right">Completely Secure and Flexible Payments</h5>
          <p class="text-right">
            We are proud to offer fast and professional delivery services with all major payment methods available through our online shop. Additionally, if you require some flexibility regarding payment, we provide finance options so you can pay in installments.
          </p>
        </div>
      </div>
      <div class="home-middle">
        ...
        <div class="home-middle-desc">
          <h5>Bulk Ordering Makes it Possible</h5>
          <p>
